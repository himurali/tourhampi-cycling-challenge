        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <AnimateOnScroll animation="slide-in-right" delay={500}>
              ...
              <ul className="space-y-3 mb-8">
                {highlights.map((item, index) => (
                  <AnimateOnScroll animation="slide-in-right" delay={600 + index * 100} key={index}>
              ...
              <AnimateOnScroll animation="slide-in-up" delay={1000}>
            ...
            <AnimateOnScroll animation="slide-in-left" delay={400}>
              <div className="relative">
                ...
                <div className="relative transform rotate-3 transition-transform hover:rotate-0 duration-500">
                  ...
                  {/* Stats overlay */}
                  <div className="absolute -bottom-6 -right-6 bg-white shadow-xl rounded-lg p-5 w-40 animate-bounce-in" style={{ animationDelay: "0.8s" }}>
                  ...
                  {/* Stats overlay */}
                  <div className="absolute -top-6 -left-6 bg-white shadow-xl rounded-lg p-5 w-40 animate-bounce-in" style={{ animationDelay: "1s" }}>
                    <div className="text-center">
